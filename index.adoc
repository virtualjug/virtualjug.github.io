...
== LIVE SESSION: What I Wish I Knew About Maven Years Ago
==== April 15, 2020
=== Andres Aalmiray ([@aalmiray](https://twitter.com/aalmiray))

{nbsp} +

video::DEOqLTxkK8A[youtube, width=100%, height=640]
